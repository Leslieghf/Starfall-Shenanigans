...
Utils.MIN_TARGET_HEIGHT = 0
Utils.MAX_TARGET_HEIGHT = 5000
Utils.HEIGHT_TRACE_LENGTH = Utils.MAX_TARGET_HEIGHT * 4
Utils.INFLUENCE_FALLOFF_EXPONENT = 4
Utils.LOOKAHEAD_TIME = 0.5
Utils.PHYSICAL_PROPERTIES_REFRESH_INTERVAL = 0.25
